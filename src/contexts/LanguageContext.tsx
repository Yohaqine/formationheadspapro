...
const translations = {
  fr: {
    ...
    "why.feature1.description": "Un Head Spa se facture entre 80€ et 150€. Avec une formation à 190€, votre investissement est rentabilisé dès le 2ème client.",
    "why.feature2.title": "Expertise Japonaise",
    "why.feature2.subtitle": "Shiatsu & Massage",
    "why.feature2.description": "Maîtrisez les techniques ancestrales du shiatsu crânien, combinées aux protocoles modernes de trichologie pour des résultats visibles.",
    "why.feature3.title": "Certificat & Suivi",
    "why.feature3.subtitle": "Accompagnement Premium",
    "why.feature3.description": "Obtenez votre certification officielle et bénéficiez d'un suivi post-formation pour perfectionner votre pratique.",
    "why.feature4.title": "Communauté",
    "why.feature4.subtitle": "Réseau d'Experts",
    "why.feature4.description": "Rejoignez une communauté passionnée de professionnels du bien-être et partagez vos expériences.",
    "why.video.text": "Découvrez l'univers",

    // Instructor
    "instructor.label": "Votre Formatrice",
    "instructor.years": "Années d'expertise",
    "instructor.bio1": "Fondatrice de Spa Woda et pionnière du Head Spa en France, Yohaqîne a forgé son expertise au cœur de",
    ...
    "instructor.bio2.end": ", la science trichologique moderne et une approche holistique du bien-être. Chaque geste est pensé pour créer une expérience sensorielle inoubliable.",
    "instructor.bio3": "Plus qu'une formation, c'est une transmission : celle d'un savoir-faire d'exception et d'une philosophie où",
    ...
    "curriculum.subtitle": "De la théorie à la pratique, maîtrisez chaque aspect du Head Spa pour offrir des expériences d'exception.",
    "curriculum.duration": "Durée :",
    "curriculum.module1.title": "Module 1 : Introduction au Head Spa",
    "curriculum.module1.duration": "1h30",
    "curriculum.module1.topics": "Histoire et philosophie du Head Spa japonais,Les bienfaits thérapeutiques et esthétiques,Comprendre les attentes clients,Créer une expérience sensorielle unique",
    "curriculum.module2.title": "Module 2 : Anatomie & Trichologie",
    "curriculum.module2.duration": "2h",
    "curriculum.module2.topics": "Anatomie du cuir chevelu et des follicules,Les différents types de cheveux et leurs besoins,Diagnostic capillaire approfondi,Pathologies courantes et solutions adaptées",
    "curriculum.module3.title": "Module 3 : Techniques de Massage",
    "curriculum.module3.duration": "3h",
    "curriculum.module3.topics": "Les bases du Shiatsu crânien,Pressions, effleurages et pétrissages,Techniques de relaxation profonde,Protocole signature Spa Woda",
    "curriculum.module4.title": "Module 4 : Rituels & Protocoles",
    "curriculum.module4.duration": "2h30",
    "curriculum.module4.topics": "Sélection et utilisation des huiles essentielles,Les outils professionnels du Head Spa,Déroulé complet d'une séance,Personnalisation selon les besoins clients",
    "curriculum.module5.title": "Module 5 : Expérience Client",
    "curriculum.module5.duration": "1h30",
    "curriculum.module5.topics": "Accueil et prise en charge du client,Communication et conseil personnalisé,Gestion des attentes et fidélisation,Créer une ambiance immersive",
    "curriculum.module6.title": "Module 6 : Certification & Pratique",
    "curriculum.module6.duration": "En présentiel",
    "curriculum.module6.topics": "Mise en situation réelle,Correction et perfectionnement des gestes,Évaluation finale,Remise du certificat Spa Woda",
    ...
    "pricing.digital.features": "Accès immédiat et illimité,10+ heures de vidéo HD,Supports PDF téléchargeables,Accès au groupe privé,Certificat de formation,Mises à jour gratuites",
    ...
    "pricing.immersion.features": "Formation en ligne incluse,1 journée intensive en présentiel,Pratique sur modèles réels,Correction personnalisée,Suivi post-formation illimité",
    ...
    "contact.subtitle": "Vous hésitez entre le Digital et le Présentiel ? Discutons de votre projet pour trouver la formule idéale.",
  ...
  en: {
    ...
    "hero.headline1": "Don't just provide treatments.",
    ...
    "why.feature1.description": "A Head Spa session is priced between €80 and €150. With training at €190, your investment pays off from the 2nd client.",
    "why.feature2.title": "Japanese Expertise",
    "why.feature2.subtitle": "Shiatsu & Massage",
    "why.feature2.description": "Master ancestral cranial shiatsu techniques, combined with modern trichology protocols for visible results.",
    "why.feature3.title": "Certificate & Support",
    "why.feature3.subtitle": "Premium Coaching",
    "why.feature3.description": "Obtain your official certification and benefit from post-training follow-up to perfect your practice.",
    ...
    "instructor.bio1": "Founder of Spa Woda and pioneer of Head Spa in France, Yohaqîne forged her expertise at the heart of",
    ...
    "instructor.bio2.end": ", modern trichological science and a holistic approach to well-being. Every gesture is designed to create an unforgettable sensory experience.",
    ...
    "curriculum.subtitle": "From theory to practice, master every aspect of Head Spa to deliver exceptional experiences.",
    "curriculum.duration": "Duration:",
    "curriculum.module1.title": "Module 1: Introduction to Head Spa",
    "curriculum.module1.duration": "1h30",
    "curriculum.module1.topics": "History and philosophy of Japanese Head Spa,Therapeutic and aesthetic benefits,Understanding client expectations,Creating a unique sensory experience",
    "curriculum.module2.title": "Module 2: Anatomy & Trichology",
    "curriculum.module2.duration": "2h",
    "curriculum.module2.topics": "Scalp and follicle anatomy,Different hair types and their needs,In-depth hair diagnosis,Common conditions and tailored solutions",
    "curriculum.module3.title": "Module 3: Massage Techniques",
    "curriculum.module3.duration": "3h",
    "curriculum.module3.topics": "Fundamentals of cranial Shiatsu,Pressure, effleurage and kneading,Deep relaxation techniques,Spa Woda signature protocol",
    "curriculum.module4.title": "Module 4: Rituals & Protocols",
    "curriculum.module4.duration": "2h30",
    "curriculum.module4.topics": "Selection and use of essential oils,Professional Head Spa tools,Complete session flow,Personalization based on client needs",
    "curriculum.module5.title": "Module 5: Client Experience",
    "curriculum.module5.duration": "1h30",
    "curriculum.module5.topics": "Welcome and client care,Communication and personalized advice,Managing expectations and loyalty,Creating an immersive atmosphere",
    "curriculum.module6.title": "Module 6: Certification & Practice",
    "curriculum.module6.duration": "In-person",
    "curriculum.module6.topics": "Real-world practice sessions,Gesture correction and refinement,Final evaluation,Spa Woda certificate delivery",
    ...
    "pricing.digital.features": "Immediate and unlimited access,10+ hours of HD video,Downloadable PDF materials,Private group access,Training certificate,Free updates",
    ...
    "pricing.immersion.features": "Online training included,1 intensive in-person day,Practice on real models,Personalized feedback,Unlimited post-training support",
