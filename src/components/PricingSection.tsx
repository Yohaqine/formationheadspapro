...
const PricingSection = () => {
  ...
  return <section id="pricing" className="relative overflow-hidden bg-stone py-24 lg:py-32">
      {/* Background Elements */}
      ...
      <div className="container relative z-10 mx-auto px-6">
        ...
        <div className="mb-16 text-center">
          ...
          once: true
            ...
            Choisissez votre <span className="text-gold italic">parcours</span>
          </motion.h2>
        </div>
        ...
        <div className="mx-auto grid max-w-4xl gap-8 lg:grid-cols-2">
          ...
          delay: 0.1
            ...
            <div className="mb-6 mt-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-2xl text-foreground">Digital</h3>
                <p className="text-sm text-muted-foreground">100% en ligne</p>
              </div>
            </div>
            ...
            <ul className="mb-8 space-y-3">
              {["Accès immédiat et illimité", "10+ heures de vidéo HD", "Supports PDF téléchargeables", "Accès au groupe privé", "Certificat de formation", "Mises à jour gratuites"].map((feature, index) => <li key={index} className="flex items-center gap-3 text-sm text-foreground/80">
            ...
            {/* CTA */}
            <a href="https://www.spawoda.fr/order-form/eyJmIjoxNjQxNDR9/" target="_blank" rel="noopener noreferrer" className="btn-gold block w-full rounded-full py-4 text-center font-body text-sm uppercase tracking-wider">
          ...
          delay: 0.2
            ...
            <div className="mb-6 mt-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-2xl text-foreground">Immersion</h3>
                <p className="text-sm text-muted-foreground">1 Journée à Lyon</p>
              </div>
            </div>
            ...
            {/* Features */}
            <ul className="mb-8 space-y-3">
              {["Formation en ligne incluse", "1 journée intensive en présentiel", "Pratique sur modèles réels", "Correction personnalisée", "Suivi post-formation illimité"].map((feature, index) => <li key={index} className="flex items-center gap-3 text-sm text-foreground">
                  <Check className="h-4 w-4 shrink-0 text-gold" />
                  {feature}
                </li>)}
            </ul>
            ...
            <div className="flex flex-col gap-3">
              <button onClick={scrollToCurriculum} className="btn-stone w-full rounded-full py-4 text-center font-body text-sm uppercase tracking-wider">
                Voir le programme
              </button>
              <button onClick={scrollToContact} className="btn-gold w-full rounded-full py-4 text-center font-body text-sm uppercase tracking-wider">
                Candidater
              </button>
            </div>
