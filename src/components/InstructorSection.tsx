...
const InstructorSection = () => {
  return (
    <section className="relative overflow-hidden bg-stone-gradient py-24 lg:py-32">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            >
              <p className="font-display text-3xl font-light text-gold">10+</p>
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {["Shiatsu Certifié", "Trichologie", "Luxury Hospitality", "Head Spa Expert"].map(
                (credential, index) => (
                  <motion.span
                    key={credential}
